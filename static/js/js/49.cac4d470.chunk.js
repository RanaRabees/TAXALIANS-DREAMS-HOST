        ...
        "A/Ql": function(a) {
            a.exports = {
                attachment: {
                    ...
                    errorSize: "File must be smaller than 25 MB",
                    uploading: "Uploading your attachment..."
                },
                automessage: {
                    emailCapturedSuccess: "Thanks for submitting your email",
                    emailCaptureMessage: "Hey there! We\u2019re excited to help you out. Let us know your email address so that we can follow up in case we get disconnected."
                },
                composer: {
                    footer: {
                        meetingPoweredByDrift: "Meeting <0/> by Drift",
                        poweredByDrift: "Chat <0/> by <1>Drift</1>"
                    },
                    replyDisabled: "Replies are disabled",
                    replyToPlaceholder: "Reply to {{name}}",
                    chooseOptionAbove: "Choose an option above..."
                },
                "String Identifier": "English (United States)",
                titleNotifier: {
                    newMessageNotification: "New Messages"
                },
                dt: {
                    day: {
                        friday: "Friday",
                ...
                emoji: {
                    ...
                    categorieslabel: "Emoji category",
                    clear: "Clear",
                ...
                greeting: {
                    awayMessage: "Hi there! So we\u2019re away right now, but if you leave us a message we\u2019ll get back to you soon.",
                    onlineMessage: "How can we help? We're here for you!"
                },
                header: {
                    senderInfo: "{{name}} from {{orgName}}"
                },
                meeting: {
                    bookAMeeting: "Book a meeting",
                    bookAMeetingWith: "Book a meeting with",
                    bookThisMeeting: "Book this meeting",
                    chooseADay: "Choose a day",
                    chooseATime: "Choose a time",
                    chooseNewTime: "Choose a new time",
                    chooseTimezone: "Change time zone",
                    duration: "{{duration}} minutes",
                    meetingWithPre: "Schedule a meeting with",
                    meetingWithPost: "Meeting with",
                    next: "Next",
                    prev: "Prev",
                    recipients: "{{name}} and {{others}} others",
                    meetingWith: "Meeting with {{name}}",
                    schedule: "Schedule",
                    scheduleAMeeting: "Schedule a Meeting",
                    scheduleAMeetingAlreadyBookedError: "Sorry, it looks like someone has already scheduled this time slot with {{agent}}.",
                    scheduleAMeetingError: "Sorry about that! We ran into an error on our end - please try again.",
                    scheduleAMeetingTimePassedError: "Sorry, the time you chose has already passed! Please pick a new time.",
